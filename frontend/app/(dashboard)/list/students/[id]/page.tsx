...
import BigCalendar from "@/frontend/components/BigCalender";
import Performance from "@/frontend/components/Performance";
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold">Keep Up!</h1>
                <span className="text-sm text-gray-400">Remark</span>
              </div>
            </div>
            {/* CARD */}
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
